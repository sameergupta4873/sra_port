...
{
    lsa_reading[0] =  adc1_get_raw(ADC1_CHANNEL_6);
    lsa_reading[1] =  adc1_get_raw(ADC1_CHANNEL_7);
    lsa_reading[2] =  adc1_get_raw(ADC1_CHANNEL_0);
    lsa_reading[3] =  adc1_get_raw(ADC1_CHANNEL_3);

    /*reducing all the value in terms of BLACK and WHITE*/
